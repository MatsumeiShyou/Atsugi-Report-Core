...
ITEM_TO_CATEGORY = {
    "段ボール": "①段ボール", "E段": "①段ボール",
    "新聞": "②新聞",
    "雑誌": "③雑誌", "雑紙": "③雑誌", "雑がみ": "③雑誌", "ミックス紙": "③雑誌",
    "PETボトル": "④プラ類", "ペットボトル": "④プラ類", "ストレッチフィルム": "④プラ類", "シュリンクフィルム": "④プラ類", 
    "PPバンド": "④プラ類", "廃プラ軟質": "④プラ類", "プラスチックパレット": "④プラ類", "フイルム": "④プラ類", "フィルム": "④プラ類",
    "牛乳パック": "⑤その他", "ウエス": "⑤その他", "台紙": "⑤その他", "上床紙": "⑤その他",
    "模造": "⑤その他", "クラフト": "⑤その他", "色クラフト": "⑤その他", "突付建材": "⑤その他", 
    "上白": "⑤その他", "納パック": "⑤その他", "紙管": "⑤その他", "シュレッダー": "⑤その他",
    "ケン特": "⑤その他", "上ケン特": "⑤その他", "損紙": "⑤その他", "白・色混り": "⑤その他",
    "ワンプ": "⑤その他", "カップ原紙": "⑤その他", "マルチパック": "⑤その他", "その他": "⑤その他"
}

# --- ユーザー定義CSVからの動的マッピング拡張 ---
import os
try:
    from user_mapping_loader import load_user_mappings
    _map_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../Artifacts/user_mappings.csv")
    _user_items, _user_clients = load_user_mappings(_map_path)
    ITEM_TO_CATEGORY.update(_user_items)
    for _client, _route in _user_clients.items():
        if _route == "1.輸出" and _client not in EXPORT_CLIENT_KEYWORDS:
            EXPORT_CLIENT_KEYWORDS.append(_client)
except ImportError:
    pass
# -----------------------------------------------
